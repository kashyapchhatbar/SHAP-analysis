...
def model_data(best_params):
    ...
    return model, X_train, X_test, X_combined
...
if __name__ == "__main__":
    ...
    model, X_train, X_test, X_combined = model_data(find_best_params(snakemake.input.optuna_storage))
    ...
    explainer = shap.TreeExplainer(model, X_train_summary.data)
